  ...
  "1": [
    {
      ...
      replies: [
        { id: "c1r1", author: "my_instagram", text: "Thank you so much! 🙏✨", created_time: "2024-06-12T19:30:00Z", likes: 4 },
      ],
    },
    {
  ...
  "2": [
    {
      ...
      replies: [
        { id: "c3r1", author: "my_instagram", text: "More coming soon! Stay tuned 🎬", created_time: "2024-06-07T13:30:00Z", likes: 3 },
        { id: "c3r2", author: "photo.lover", text: "Can't wait! 🔥", created_time: "2024-06-07T14:00:00Z", likes: 2 },
      ],
    },
    {
  ...
  "3": [
    {
      ...
      replies: [
        { id: "c5r1", author: "my_instagram", text: "You've got this! 💪🔥", created_time: "2024-06-01T09:30:00Z", likes: 6 },
      ],
    },
    {
    ...
    },
    {
      ...
      replies: [
        { id: "c7r1", author: "my_instagram", text: "Always happy to inspire! ❤️", created_time: "2024-06-01T11:30:00Z", likes: 5 },
      ],
    },
  ],
};
...
export async function getInstagramComments(mediaId) {
  ...
  try {
    const fields = "id,text,username,timestamp,replies{id,text,username,timestamp,like_count}";
    const url = `https://graph.facebook.com/v19.0/${encodeURIComponent(mediaId)}/comments?fields=${encodeURIComponent(fields)}`;
...
export async function postInstagramComment(mediaId, text, replyTo) {
  const token = process.env.INSTAGRAM_ACCESS_TOKEN;
  ...
  try {
    // If replying to a specific comment, use the /replies endpoint on that comment
    const url = replyTo
      ? `https://graph.facebook.com/v19.0/${encodeURIComponent(replyTo)}/replies`
