...
const MOCK_FACEBOOK_COMMENTS = {
  "1": [
    {
      ...
      replies: [
        { id: "c1r1", author: "Page Admin", text: "Thanks Alice! Big news coming very soon 🚀", created_time: "2024-06-10T15:45:00Z", likes: 3 },
      ],
    },
    {
    ...
    },
    {
      ...
      replies: [
        { id: "c3r1", author: "Page Admin", text: "We really appreciate that, Carol! 🙏", created_time: "2024-06-10T18:30:00Z", likes: 2 },
        { id: "c3r2", author: "Alice Johnson", text: "Same! So excited for what's next.", created_time: "2024-06-10T19:00:00Z", likes: 1 },
      ],
    },
  ],
  "2": [
    {
      ...
      replies: [
        { id: "c4r1", author: "Page Admin", text: "Thank you so much David! Couldn't have done it without all of you 💙", created_time: "2024-06-05T11:30:00Z", likes: 5 },
      ],
    },
    {
  ...
  "3": [
    ...
    },
    {
      ...
      replies: [
        { id: "c7r1", author: "Page Admin", text: "Great idea, Grace! We're already working on a follow-up 📝", created_time: "2024-05-28T11:45:00Z", likes: 4 },
      ],
    },
  ],
};
...
export async function postFacebookComment(postId, message, replyTo) {
  const token = process.env.FACEBOOK_ACCESS_TOKEN;
  ...
  try {
    // If replying to a specific comment, post to that comment's ID endpoint
    const targetId = replyTo ?? postId;
    const url =
      `https://graph.facebook.com/v19.0/${encodeURIComponent(targetId)}/comments` +
      `?access_token=${encodeURIComponent(token)}`;
